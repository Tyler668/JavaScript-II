...
ticketPriceTotal = runners.reduce(function(acc, curr,){
...
// Problem 1
//Still drunk with power, the fun run director has decided that people donating less than $100 will be penalized. Separate them into a new array for public shaming.

let poorBois = [];
poorBois = runners.filter(function(runner){
